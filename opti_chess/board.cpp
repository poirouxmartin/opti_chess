...
{
	// Overflow guard: silently drop instead of overflowing _moves[] into
	// adjacent Board members (no cout: this is a generation-hot path; the cap
	// is a deliberate memory optimization and almost never binds).
