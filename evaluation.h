...
class Evaluator {
    ...
    int _pos_knight_begin[8][8]     {   { -66,  -53,  -75,  -75,  -10,  -55,  -58,  -70},
                                        ...
                                        { -10,   24,   40,   55,   55,   40,   25,   20},
                                        { -10,    5,   31,   45,   45,   35,    2,    0},
                                        { -18,   10,   25,   22,   18,   30,   14,  -14},
                                        { -40,  -15,    2,    5,    2,    0,  -23,  -25},
                                        { -74,  -20,  -26,  -24,  -19,  -30,  -20,  -69}   };
    ...
    int _pos_bishop_begin[8][8]     {   { -59,  -78,  -82,  -76,  -23, -107,  -37,  -50},
                                        ...
                                        {  13,   10,   25,   23,   17,   20,    0,    7},
                                        {  14,   25,   24,   20,   15,   25,   20,   15},
                                        {  19,   30,   11,   10,   15,    6,   35,   16},
    ...
    int _pos_queen_begin[8][8]      {   { -50,  -50,  -50,  -50,  -50,  -50,  -50,  -50},
                                        ...
                                        {  40,    0,   10,  -20,  -60,   10,   20,    0},
                                        {   0,  -10,  -30,   20,  -70,   20,    0,    0},
                                        { -40,  -20,   10,  -10,   10,    0,  -20,  -40},
                                        { -80,  -40,  -20,  100,   10,  -40,  -40,  -80}   };
